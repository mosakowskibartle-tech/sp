          ...
          >
            ...
            {step === 'success' && (
              <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                ...
                <p className="text-sp-cream/60 mb-3 text-sm">Мы свяжемся с вами для подтверждения</p>
                {orderId && (
                  <a href={`/order/${orderId}`} onClick={handleClose} className="text-sp-orange text-sm underline mb-4 block">
                    Следить за статусом заказа #{orderId} →
                  </a>
                )}
